...
public class ContentCategoryController {
	...
	public PageInfo<ContentCategory> findPage(Integer page, Integer rows) throws Exception {
		PageInfo<ContentCategory> pageInfo = categoryService.findPage(null, page, rows);
		return pageInfo;
	}
	...
	public PageInfo<ContentCategory> search(@RequestBody ContentCategory contentCategory, Integer page, Integer rows)
			throws Exception {
		PageInfo<ContentCategory> pageInfo = categoryService.findPage(contentCategory, page, rows);
		return pageInfo;
	}
}
