...
@Service
public class SellerEchartsServiceImpl implements SellerEchartsService {

    @Resource
    private OrderDao orderDao;

    @Override
    public LinkedHashMap<String, Double> echartsData(String sellerId) {
        //一天的毫秒数值
        ...
        try {
            ...
            List<Order> allOrderList = orderDao.selectByExample(query);
